    ...
    <nav id="js-primary-nav" class="primary-nav" role="navigation">
        ...
        <ul id="js-nav-menu" class="nav-menu">
            ...
            <li class="{{ set_active('/submissions') }}">
                <a href="/submissions" title="Penyerahan Barang" data-filter-tags="penyerahan barang">
                    <i class="fal fa-inbox-out"></i>
                    <span class="nav-link-text" data-i18n="nav.penyerahan_barang">Penyerahan Barang</span>
                </a>
            </li>
            <li class="{{ set_active('/penerimaan-barang') }}">
                <a href="/penerimaan-barang" title="Penerimaan Barang" data-filter-tags="penerimaan barang">
                    <i class="fal fa-inbox-in"></i>
                    <span class="nav-link-text" data-i18n="nav.penerimaan_barang">Penermaan Barang</span>
                </a>
            </li>
            @endcan
            ...
            @can('superadmin')
            <li class="{{ set_active_mainmenu(['units','item-sets','items','users']) }}">
                ...
                <ul>
                    <li class="{{ set_active('units') }}">
                        <a href="/units" title="Unit" data-filter-tags="master data unit">
                            <span class="nav-link-text" data-i18n="nav.master_data_unit">Unit /
                                Ruang</span>
                        </a>
                    </li>
                    <li class="{{ set_active('item-sets') }}">
                        <a href="/item-sets" title="Set Alat" data-filter-tags="master data set alat">
                            <span class="nav-link-text" data-i18n="nav.master_data_item_sets">Set Alat /
                                Instrument</span>
                        </a>
                    </li>
                    <li class="{{ set_active('items') }}">
                        <a href="/items" title="Alat" data-filter-tags="master data alat">
                            <span class="nav-link-text" data-i18n="nav.master_data_alat">Alat</span>
                        </a>
                    </li>
