...
<aside class="page-sidebar">
    ...
    <nav id="js-primary-nav" class="primary-nav" role="navigation">
        ...
        <ul id="js-nav-menu" class="nav-menu">
            ...
            <li class="{{ set_active_mainmenu(['units','item-sets','items']) }}">
                ...
                <ul>
                    ...
                    <li class="{{ set_active('item-sets') }}">
                        <a href="/item-sets" title="Set Alat" data-filter-tags="master data intel set alat">
                            <span class="nav-link-text" data-i18n="nav.master_data_item_sets">Set Alat /
                                Instrument</span>
                        </a>
                    </li>
                    <li class="{{ set_active('items') }}">
                        <a href="/items" title="Alat" data-filter-tags="master data intel alat">
