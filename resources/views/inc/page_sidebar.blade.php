...
<aside class="page-sidebar">
    ...
    <nav id="js-primary-nav" class="primary-nav" role="navigation">
        ...
        <ul id="js-nav-menu" class="nav-menu">
            ...
            <li class="{{ set_active_mainmenu(['ui_alerts','ui_accordion','ui_badges','ui_breadcrumbs','ui_buttons','ui_button_group','ui_cards','ui_carousel','ui_collapse','ui_dropdowns','ui_list_filter','ui_modal','ui_navbars','ui_panels','ui_pagination','ui_popovers','ui_progress_bars','ui_scrollspy','ui_side_panel','ui_spinners','ui_tabs_pills','ui_toasts','ui_tooltips']) }}">
            ...
            <li class="{{ set_active_mainmenu(['utilities_borders','utilities_clearfix','utilities_color_pallet','utilities_display_property','utilities_fonts','utilities_flexbox','utilities_helpers','utilities_position','utilities_responsive_grid','utilities_sizing','utilities_spacing','utilities_typography']) }}">
            ...
            <li class="{{ set_active_mainmenu(['icons_fontawesome_light','icons_fontawesome_regular','icons_fontawesome_solid','icons_fontawesome_brand','icons_nextgen_general','icons_nextgen_base','icons_stack_showcase','icons_stack_generate']) }}">
                ...
                <ul>
                    <li class="{{ set_active_mainmenu(['icons_fontawesome_light','icons_fontawesome_regular','icons_fontawesome_solid','icons_fontawesome_brand']) }}">
            ...
            <li class="{{ set_active_mainmenu(['form_basic_inputs','form_checkbox_radio','form_input_groups','form_validation','form_elements','form_samples']) }}">
            ...
            <li class="{{ set_active_mainmenu(['plugin_faq','plugin_waves','plugin_pacejs','plugin_smartpanels','plugin_bootbox','plugin_slimscroll','plugin_throttle','plugin_navigation','plugin_i18next','plugin_appcore']) }}">
            ...
            <li class="{{ set_active_mainmenu(['statistics_flot','statistics_chartjs','statistics_chartist','statistics_c3','statistics_peity','statistics_sparkline','statistics_easypiechart','statistics_dygraph']) }}">
            ...
            <li class="{{ set_active_mainmenu(['form_plugins_colorpicker','form_plugins_datepicker','form_plugins_daterange_picker','form_plugins_dropzone','form_plugins_ionrangeslider','form_plugins_inputmask','form_plugin_imagecropper','form_plugin_select2','form_plugin_summernote']) }}">
            ...
            <li class="{{ set_active_mainmenu(['page_chat','page_contacts','page_forum_list','page_forum_threads','page_forum_discussion','page_inbox_general','page_inbox_read','page_inbox_write','page_invoice','page_forget','page_locked','page_login','page_login-alt','page_register','page_confirmation','page_error','page_error_404','page_error_announced','page_profile','page_search','blank']) }}">
                ...
                <ul>
                    ...
                    <li class="{{ set_active_mainmenu(['page_forum_list','page_forum_threads','page_forum_discussion']) }}">
                    ...
                    <li class="{{ set_active_mainmenu(['page_inbox_general','page_inbox_read','page_inbox_write']) }}">
                    ...
                    <li class="{{ set_active_mainmenu(['page_error','page_error_404','page_error_announced']) }}">
