    ...
    <nav id="js-primary-nav" class="primary-nav" role="navigation">
        ...
        <ul id="js-nav-menu" class="nav-menu">
            ...
            <li class="@yield('menupackage')">
                ...
                <ul>
                    <li class="@yield('menuinfo_app_docs')">
            ...
            <li class="@yield('menuui_components')">
                ...
                <ul>
                    ...
                    <li class="@yield('menuui_accordion')">
                    ...
                    <li class="@yield('menuui_breadcrumbs')">
                    ...
                    <li class="@yield('menuui_button_group')">
                    ...
                    <li class="@yield('menuui_carousel')">
                    ...
                    <li class="@yield('menuui_collapse')">
                    ...
                    <li class="@yield('menuui_dropdowns')">
                    ...
                    <li class="@yield('menuui_list_filter')">
                    ...
                    <li class="@yield('menuui_pagination')">
                    ...
                    <li class="@yield('menuui_popovers')">
                    ...
                    <li class="@yield('menuui_scrollspy')">
                    ...
                    <li class="@yield('menuui_side_panel')">
                    ...
                    <li class="@yield('menuui_spinners')">
                    ...
                    <li class="@yield('menuui_tabs_pills')">
                    ...
                    <li class="@yield('menuui_tooltips')">
            ...
            <li class="@yield('menuform_stuff')">
                ...
                <ul>
                    ...
                    <li class="@yield('menuform_validation')">
                    ...
                    <li class="@yield('menuform_elements')">
            ...
            <li class="@yield('menuplugins')">
                ...
                <ul>
                    ...
                    <li class="@yield('menuplugin_waves')">
                    ...
                    <li class="@yield('menuplugin_pacejs')">
                    ...
                    <li class="@yield('menuplugin_smartpanels')">
                    ...
                    <li class="@yield('menuplugin_bootbox')">
                    ...
                    <li class="@yield('menuplugin_slimscroll')">
                    ...
                    <li class="@yield('menuplugin_throttle')">
                    ...
                    <li class="@yield('menuplugin_navigation')">
                    ...
                    <li class="@yield('menuplugin_i18next')">
                    ...
                    <li class="@yield('menuplugin_appcore')">
            ...
            <li class="@yield('menudatatables')">
                ...
                <ul>
                    <li class="@yield('menudatatables_basic')">
                    ...
                    <li class="@yield('menudatatables_autofill')">
                    ...
                    <li class="@yield('menudatatables_buttons')">
                    ...
                    <li class="@yield('menudatatables_keytable')">
                    ...
                    <li class="@yield('menudatatables_rowgroup')">
                    ...
                    <li class="@yield('menudatatables_scroller')">
                    ...
                    <li class="@yield('menudatatables_select')">
            ...
            <li class="@yield('menustatistics')">
                ...
                <ul>
                    <li class="@yield('menustatistics_flot')">
                    ...
                    <li class="@yield('menustatistics_c3')">
            ...
            <li class="@yield('menunotifications')">
                ...
                <ul>
                    ...
                    <li class="@yield('menunotifications_toastr')">
            ...
            <li class="@yield('menuform_plugins')">
                ...
                <ul>
                    ...
                    <li class="@yield('menuform_plugin_select2')">
            ...
            <li class="@yield('menumiscellaneous')">
            ...
            <li class="@yield('menupages')">
                ...
                <ul>
                    ...
                    <li class="@yield('menupages_forum')">
                        ...
                        <ul>
                            <li class="@yield('menupage_forum_list')">
                            ...
                            <li class="@yield('menupage_forum_threads')">
                    ...
                    <li class="@yield('menupages_inbox')">
                        ...
                        <ul>
                            <li class="@yield('menupage_inbox_general')">
                            ...
                            <li class="@yield('menupage_inbox_read')">
                            ...
                            <li class="@yield('menupage_inbox_write')">
                    ...
                    <li class="@yield('menupages_error_pages')">
                    ...
                    <li class="@yield('menupages_profile')">
                    ...
                    <li class="@yield('menupages_search_results')">
                    ...
                    <li class="@yield('menupages_blank')">
