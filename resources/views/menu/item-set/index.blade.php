    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        Set Alat <span class="fw-300"><i>Table</i></span>
                    </h2>
                        ...
                        <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="white-space: nowrap"><a href="/item-sets/{{ $item_set->id }}" class="">{{
                                            strtoupper($item_set->name) }}</a></td>
                                    <td style="white-space: nowrap">{{ $item_set->code }}</td>
                                    <td style="white-space: nowrap">{{ $item_set->status == "1" ? "Aktif" : "Nonaktif"
                                        }}
                                    </td>
                                    <td style="white-space: nowrap">
                                        <button type="button" class="badge mx-1 badge-primary p-2 border-0 text-white"
                                            data-toggle="modal" data-target="#ubah-item-set{{ $item_set->id }}"
                                            title="Ubah">
                                ...
                                <div class="modal fade" id="ubah-item-set{{ $item_set->id }}" tabindex="-1"
                                    role="dialog" aria-hidden="true">
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <form autocomplete="off" novalidate action="/item-sets/{{ $item_set->id }}"
                                                method="post">
                                                @method('put')
                                                @csrf
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <label for="name">Nama Set Alat</label>
                                                        <input type="text" value="{{ old('name', $item_set->name) }}"
                                                            class="form-control @error('name') is-invalid @enderror"
                                                            id="name" name="name" placeholder="Nama Set Alat">
                                                        @error('name')
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control w-100" id="ubahStatus"
                                                            name="status">
                                                            <option value="1" {{ $item_set->status == "1" ? 'selected' :
                                                                ''
                                                                }}>Aktif</option>
                                                            <option value="0" {{ $item_set->status == "0" ? 'selected' :
                                                                ''
                                                                }}>Nonaktif</option>
                                                        </select>
                                                    </div>
