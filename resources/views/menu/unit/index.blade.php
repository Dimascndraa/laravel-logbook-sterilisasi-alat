                        ...
                        <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                            <thead>
                                <tr>
                                    ...
                                    <th style="white-space: nowrap">Kode Unit</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="white-space: nowrap"><a href="/units/{{ $unit->id }}" class="">{{
                                            strtoupper($unit->name) }}</a></td>
                                    <td style="white-space: nowrap">{{ $unit->code }}</td>
                                    <td style="white-space: nowrap">{{ $unit->status == "1" ? "Aktif" : "Nonaktif" }}
                                    </td>
                                    <td style="white-space: nowrap">
                                        <button type="button" class="badge mx-1 badge-primary p-2 border-0 text-white"
                                            data-toggle="modal" data-target="#ubah-unit{{ $unit->id }}" title="Ubah">
                                            <span class="fal fa-pencil mr-1"></span>
                                        </button>
                                    </td>
                                </tr>

                                <div class="modal fade" id="ubah-unit{{ $unit->id }}" tabindex="-1" role="dialog"
                                    aria-hidden="true">
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <form autocomplete="off" novalidate action="/units/{{ $unit->id }}"
                                                method="post">
                                                @method('put')
                                                @csrf
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{ old('name', $unit->name) }}"
                                                            class="form-control @error('name') is-invalid @enderror"
                                                            id="name" name="name" placeholder="Nama Unit">
                                                        @error('name')
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{ old('code', $unit->code) }}"
                                                            class="form-control @error('code') is-invalid @enderror"
                                                            id="code" name="code" placeholder="Kode Unit"
...
<div class="modal fade" id="default-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form autocomplete="off" novalidate action="/units" method="post">
                @csrf
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ old('code') }}"
                            ...
                            placeholder="Kode Unit" onkeyup="this.value = this.value.toUpperCase()">
                        @error('code')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
